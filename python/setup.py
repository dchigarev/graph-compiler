...
PKG_DIR = os.path.join(PROJ_DIR, "build", "lib", "Bindings", "Python")
...
def compile():
    ...
    with open(os.path.join(PROJ_DIR, "python", "src", "__init__.py"),
              "r") as src, open(os.path.join(PKG_DIR, "__init__.py"),
                                "w") as dst:
        dst.write(src.read())
