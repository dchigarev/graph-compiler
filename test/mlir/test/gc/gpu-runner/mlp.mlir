// RUN: gc-opt %s --pass-pipeline=%p/imex-gpu.pp | imex-cpu-runner -e main -entry-point-result=void --shared-libs=%mlir_runner_utils,%mlir_c_runner_utils,%levelzero_runtime | FileCheck %s
